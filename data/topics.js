  ...
  "topics": [
    {
      ...
      "dailyExample": {
        ...
        "table": [
          { "label": "Round 0", "value": "1 person" },
          { "label": "Round 1", "value": "3 people" },
          { "label": "Round 2", "value": "9 people" },
          { "label": "Round 3", "value": "27 people" },
          { "label": "Round 4", "value": "81 people" }
        ]
      },
      "extraExample": {
        ...
        "table": [
          { "label": "Hour 0", "value": "1 cell" },
          { "label": "Hour 1", "value": "2 cells" },
          { "label": "Hour 2", "value": "4 cells" },
          { "label": "Hour 3", "value": "8 cells" },
          { "label": "Hour 4", "value": "16 cells" }
        ]
      },
      "solvedProblem": {
        "question": "Find the value of y = 3â´",
        "steps": [
          { "step": 1, "text": "Write it out as repeated multiplication", "math": "3â´ = 3 Ã— 3 Ã— 3 Ã— 3" },
          { "step": 2, "text": "Multiply the first two numbers", "math": "3 Ã— 3 = 9" },
          { "step": 3, "text": "Multiply by 3 again", "math": "9 Ã— 3 = 27" },
          { "step": 4, "text": "Multiply by 3 one last time", "math": "27 Ã— 3 = 81" }
        ],
        "answer": "y = 81"
      },
      "tips": [
      ...
      "quiz": [
        {
          ...
          "options": ["y = xâµ", "y = 5Ë£", "y = 5x", "y = x + 5"],
          "correct": 1,
        ...
        },
        {
          ...
          "type": "multiple-choice",
          "options": ["Grow very fast", "Stay the same", "Decay (get smaller)", "Create a straight line"],
          "correct": 2,
      ...
      "practice": [
        {
          "question": "Is y = 4Ë£ an exponential function? Why or why not?",
          "hint": "Look at where the variable x is sitting in the equation y = 4Ë£.",
          "answer": "Yes! Because x is in the exponent position (top-right of 4). The base is 4 (greater than 1), so it is an exponential GROWTH function.",
          "steps": [
            "Find x in the equation y = 4Ë£",
            "x is the tiny floating number at the top-right â†’ exponent position",
            "Base = 4, which is greater than 1",
            "Therefore: YES, it is exponential and it GROWS as x increases!"
          ]
        },
        {
          "question": "Calculate: y = 2âµ",
          "hint": "Write it as repeated multiplication first: 2 Ã— 2 Ã— 2 Ã— 2 Ã— 2",
          "answer": "y = 32",
          "steps": [
            "Write as repeated multiplication: 2âµ = 2 Ã— 2 Ã— 2 Ã— 2 Ã— 2",
            "2 Ã— 2 = 4",
            "4 Ã— 2 = 8",
            "8 Ã— 2 = 16",
            "16 Ã— 2 = 32",
    ...
    },
    {
      ...
      "dailyExample": {
        ...
        "table": [
          { "label": "Year 0", "value": "$1,000" },
          { "label": "Year 1", "value": "$2,000" },
          { "label": "Year 2", "value": "$4,000" },
          { "label": "Year 3", "value": "$8,000" }
        ]
      },
      "extraExample": {
        ...
        "table": [
          { "label": "Hour 0", "value": "10 cells" },
          { "label": "Hour 1", "value": "20 cells" },
          { "label": "Hour 2", "value": "40 cells" },
          { "label": "Hour 4", "value": "160 cells" }
        ]
      },
      "solvedProblem": {
        "question": "Bacteria start at 20 cells and double every hour. Write the equation, then find the count after 3 hours.",
        "steps": [
          { "step": 1, "text": "Identify the starting value (what is the count at time 0?)", "math": "a = 20" },
          { "step": 2, "text": "Identify the growth factor (doubles means Ã—2 each hour)", "math": "b = 2" },
          { "step": 3, "text": "Write the equation using y = a Â· bË£", "math": "N = 20 Ã— 2áµ—" },
          { "step": 4, "text": "Substitute t = 3 (for 3 hours)", "math": "N = 20 Ã— 2Â³" },
          { "step": 5, "text": "Calculate 2Â³ = 2 Ã— 2 Ã— 2", "math": "2Â³ = 8" },
          { "step": 6, "text": "Multiply the starting value by 8", "math": "N = 20 Ã— 8 = 160" }
        ],
      ...
      "quiz": [
        ...
        },
        {
          ...
          "type": "multiple-choice",
          "options": ["y = 3 Ã— 100Ë£", "y = 100 + 3x", "y = 100 Ã— 3Ë£", "y = 100 Ã— xÂ³"],
          "correct": 2,
      ...
      "practice": [
        {
          "question": "Evaluate f(x) = 4Ë£ when x = 3",
          "hint": "Write 4Â³ as repeated multiplication: 4 Ã— 4 Ã— 4",
          "answer": "64",
          "steps": [
            "Substitute x = 3: f(3) = 4Â³",
            "Write as multiplication: 4Â³ = 4 Ã— 4 Ã— 4",
            "4 Ã— 4 = 16",
            "16 Ã— 4 = 64",
            "Answer: f(3) = 64"
          ]
        ...
        {
          "question": "A virus starts with 5 infected cells and doubles every day. Write the equation.",
          "hint": "Use y = a Ã— bË£ where a is starting value and b is the growth factor (what does 'doubles' mean?).",
          "answer": "y = 5 Ã— 2Ë£",
          "steps": [
            "Starting value: a = 5 (we start with 5 infected cells)",
            "Doubling means multiplying by 2 each time: b = 2",
            "Use the formula y = a Ã— bË£",
            "Equation: y = 5 Ã— 2Ë£"
          ]
        }
      ]
    },
    {
      ...
      "dailyExample": {
        ...
        "table": [
          { "label": "Principal P", "value": "$1,000" },
          { "label": "Rate r", "value": "10% = 0.10" },
          { "label": "After 1 year", "value": "$1,100" },
          { "label": "After 2 years", "value": "$1,210" }
        ]
      },
      "extraExample": {
        ...
        "table": [
          { "label": "Type of change", "value": "Continuous" },
          { "label": "Formula used", "value": "A = P Ã— eÊ³áµ—" },
          { "label": "What is e?", "value": "â‰ˆ 2.718 (a fixed constant)" },
          { "label": "Why e?", "value": "It describes every-moment non-stop growth" }
        ]
      },
      "solvedProblem": {
        "question": "You deposit $500 at 8% annual compound interest. How much do you have after 3 years?",
        "steps": [
          { "step": 1, "text": "Identify all values from the problem", "math": "P = 500,  r = 8% = 0.08,  t = 3" },
          { "step": 2, "text": "Write the compound interest formula", "math": "A = P(1 + r)áµ—" },
          { "step": 3, "text": "Substitute the values", "math": "A = 500 Ã— (1 + 0.08)Â³" },
          { "step": 4, "text": "Simplify inside the brackets", "math": "A = 500 Ã— (1.08)Â³" },
          { "step": 5, "text": "Calculate (1.08)Â³ â‰ˆ 1.08 Ã— 1.08 Ã— 1.08", "math": "(1.08)Â³ â‰ˆ 1.2597" },
          { "step": 6, "text": "Multiply to get the final amount", "math": "A = 500 Ã— 1.2597 â‰ˆ $629.86" }
        ],
      ...
      "quiz": [
        {
          ...
          "type": "multiple-choice",
          "options": ["Percentage  ", "Principal (starting money)", "Power", "Period"],
          "correct": 1,
      ...
      "practice": [
        {
          "question": "Calculate: $1,000 deposited at 5% annual compound interest for 2 years. Use A = P(1+r)áµ—.",
          "hint": "P = 1000, r = 5% = 0.05, t = 2. Substitute into A = 1000 Ã— (1.05)Â²",
          "answer": "$1,102.50",
          "steps": [
            "Identify: P = 1000, r = 0.05, t = 2",
            "Formula: A = P(1 + r)áµ—",
            "Substitute: A = 1000 Ã— (1.05)Â²",
            "Calculate: (1.05)Â² = 1.05 Ã— 1.05 = 1.1025",
            "Multiply: A = 1000 Ã— 1.1025 = $1,102.50"
          ]
        },
        {
          "question": "What is eÂ¹? (Remember: e â‰ˆ 2.718)",
          "hint": "Any number raised to the power of 1 equals itself.",
          "answer": "eÂ¹ = e â‰ˆ 2.718",
          "steps": [
            "Any number to the power of 1 equals itself: nÂ¹ = n",
            "So eÂ¹ = e",
            "And e â‰ˆ 2.718",
            "Answer: eÂ¹ â‰ˆ 2.718"
          ]
    ...
    },
    {
      ...
      "extraExample": {
        ...
        "table": [
          { "label": "Early days", "value": "Graph is nearly flat" },
          { "label": "Middle days", "value": "Curve begins to rise" },
          { "label": "Later days", "value": "Shoots straight up!" },
          { "label": "Shape name", "value": "J-curve (exponential)" }
        ]
      },
      "solvedProblem": {
        "question": "Compare y = 2Ë£ and y = 2Ë£ + 3. How does the second graph differ from the first?",
        "steps": [
          { "step": 1, "text": "Build a value table for y = 2Ë£", "math": "x: -1, 0, 1, 2  â†’  y: 0.5, 1, 2, 4" },
          { "step": 2, "text": "Build a value table for y = 2Ë£ + 3", "math": "x: -1, 0, 1, 2  â†’  y: 3.5, 4, 5, 7" },
          { "step": 3, "text": "Compare â€” every y-value in the second table is exactly 3 more", "math": "3.5 = 0.5 + 3,   4 = 1 + 3,  etc." },
          { "step": 4, "text": "Conclusion: adding +3 shifts the ENTIRE graph upward by 3 units", "math": "Same shape, different vertical position" }
        ],
      ...
      "quiz": [
        ...
        },
        {
          ...
          "type": "multiple-choice",
          "options": ["Right 5 units", "Left 5 units", "Down 5 units", "Up 5 units"],
          "correct": 3,
        ...
        },
        {
          ...
          "type": "multiple-choice",
          "options": ["Exponential growth", "A straight line", "Exponential decay", "A circle"],
          "correct": 2,
      ...
      "practice": [
        {
          "question": "Fill in the table for y = 3Ë£ when x = 0, 1, 2",
          "hint": "Calculate 3â°, 3Â¹, and 3Â² separately. Remember: any number to power 0 is 1.",
          "answer": "y = 1, y = 3, y = 9",
          "steps": [
            "x = 0: y = 3â° = 1  (anything to power 0 is 1)",
            "x = 1: y = 3Â¹ = 3",
            "x = 2: y = 3Â² = 3 Ã— 3 = 9",
            "Table: (0, 1), (1, 3), (2, 9)"
          ]
        ...
        {
          "question": "How does y = 2Ë£ âˆ’ 4 differ from y = 2Ë£ on a graph?",
          "hint": "Look at the âˆ’ 4 at the end of the equation. What direction does subtracting move the graph?",
          "answer": "The graph shifts DOWN by 4 units",
          "steps": [
            "Identify the transformation: âˆ’4 at the end",
            "Subtracting a number at the end shifts the graph DOWN",
            "The shape stays exactly the same",
            "Every y-value is 4 less than in y = 2Ë£",
    ...
    },
    {
      ...
      "dailyExample": {
        ...
        "table": [
          { "label": "1 fold", "value": "2 layers" },
          { "label": "2 folds", "value": "4 layers" },
          { "label": "3 folds", "value": "8 layers" },
          { "label": "logâ‚‚(8) = ?", "value": "Answer: 3 folds!" }
        ]
      },
      "extraExample": {
        ...
        "table": [
          { "label": "Starting count", "value": "1 cell" },
          { "label": "Ending count", "value": "16 cells" },
          { "label": "Question asked", "value": "How many doublings?" },
          { "label": "logâ‚‚(16) =", "value": "4 doublings" }
        ]
      },
      "solvedProblem": {
        "question": "Evaluate: logâ‚‚(8) = x. Find x.",
        "steps": [
          { "step": 1, "text": "Identify the parts: base = 2, target = 8, answer = x", "math": "logâ‚‚(8) = x" },
          { "step": 2, "text": "Use the Loop Trick â€” rewrite as an exponent", "math": "2Ë£ = 8" },
          { "step": 3, "text": "Ask: 2 multiplied how many times gives 8?", "math": "2 Ã— 2 = 4,   and   4 Ã— 2 = 8" },
          { "step": 4, "text": "Count how many 2s multiplied together: three 2s!", "math": "2Â³ = 8  âœ“" }
        ],
        "answer": "x = 3"
      },
      "tips": [
      ...
      "quiz": [
        {
          ...
          "type": "multiple-choice",
          "options": ["What is 2 Ã— 8?", "What is 2 + 8?", "2 to what power equals 8?", "8 divided by 2?"],
          "correct": 2,
        ...
        },
        {
          ...
          "type": "multiple-choice",
          "options": ["25âµ = 2", "2âµ = 25", "5Â² = 25", "5Â²âµ = 2"],
          "correct": 2,
      ...
      "practice": [
        {
          "question": "Evaluate: logâ‚ƒ(9) = ?",
          "hint": "Rewrite as an exponent: 3^? = 9. Then ask yourself: 3 multiplied how many times gives 9?",
          "answer": "2",
          "steps": [
            "Rewrite using the Loop Trick: 3Ë£ = 9",
            "Ask: 3 multiplied how many times gives 9?",
            "3 Ã— 3 = 9 â†’ that is two 3s multiplied together",
            "So 3Â² = 9, therefore logâ‚ƒ(9) = 2"
          ]
        },
        {
          "question": "Convert to exponential form: logâ‚â‚€(100) = 2",
          "hint": "Use the rule: log_b(a) = c means b^c = a. Identify b, a, and c first.",
          "answer": "10Â² = 100",
          "steps": [
            "Identify parts: base b = 10, target a = 100, answer c = 2",
            "Apply the rule: b^c = a",
            "Rewrite: 10Â² = 100",
            "Check: 10 Ã— 10 = 100 âœ“"
          ]
        }
      ]
    },
    {
      ...
      "dailyExample": {
        ...
        "table": [
          { "label": "log(1)", "value": "= 0  (10â° = 1)" },
          { "label": "log(10)", "value": "= 1  (10Â¹ = 10)" },
          { "label": "log(100)", "value": "= 2  (10Â² = 100)" },
          { "label": "log(1000)", "value": "= 3  (10Â³ = 1000)" }
        ]
      },
      "extraExample": {
        "title": "The pH Scale",
        ...
        "table": [
          { "label": "Stomach acid", "value": "pH â‰ˆ 2  (very acidic)" },
          { "label": "Water (neutral)", "value": "pH = 7" },
          { "label": "Blood", "value": "pH â‰ˆ 7.4" },
          { "label": "Each pH unit", "value": "= 10Ã— difference in acidity" }
        ]
      },
      "solvedProblem": {
        "question": "Evaluate: log(1000) and ln(eÂ³)",
        "steps": [
          { "step": 1, "text": "For log(1000): ask what power of 10 gives 1000?", "math": "10^? = 1000" },
          { "step": 2, "text": "Count: 10 Ã— 10 Ã— 10 = 1000 â€” that is three 10s", "math": "10Â³ = 1000" },
          { "step": 3, "text": "First answer", "math": "log(1000) = 3" },
          { "step": 4, "text": "For ln(eÂ³): ln and e are mathematical opposites â€” they cancel each other out!", "math": "ln(eÂ³) = 3" }
        ],
      ...
      "practice": [
        {
          "question": "Find: log(100,000)",
          "hint": "Ask: 10 to what power equals 100,000? Try counting the zeros.",
          "answer": "5",
          "steps": [
            "Ask: 10^? = 100,000",
            "Count the zeros in 100,000: there are five zeros",
            "So 10âµ = 100,000",
            "Therefore: log(100,000) = 5"
          ]
        },
        {
          "question": "Find: ln(eâ·)",
          "hint": "Remember: ln and e are mathematical opposites. They cancel each other out.",
          "answer": "7",
          "steps": [
            "ln(eË£) = x is the rule â€” ln and e cancel perfectly",
            "ln(eâ·) asks: e to what power gives eâ·?",
            "The answer is right there: the power is 7",
            "ln(eâ·) = 7"
          ]
        }
      ]
    },
    {
      ...
      "dailyExample": {
        ...
        "table": [
          { "label": "x = 1",    "value": "y = 0" },
          { "label": "x = 10",   "value": "y = 1" },
          { "label": "x = 100",  "value": "y = 2" },
          { "label": "x = 1000", "value": "y = 3" }
        ]
      },
      "extraExample": {
        ...
        "table": [
          { "label": "Early reaction", "value": "Rapid change (steep rise)" },
          { "label": "Mid reaction", "value": "Slowing down" },
          { "label": "Late reaction", "value": "Almost flat" },
          { "label": "y-axis", "value": "Curve never crosses it" }
        ]
      },
      "solvedProblem": {
        "question": "Find the domain of y = log(x âˆ’ 3)",
        "steps": [
          { "step": 1, "text": "Rule: the expression INSIDE the log must be greater than zero", "math": "x âˆ’ 3 > 0" },
          { "step": 2, "text": "Solve the inequality by adding 3 to both sides", "math": "x > 3" },
          { "step": 3, "text": "Write the domain", "math": "Domain: x > 3" },
          { "step": 4, "text": "Bonus: the graph shifts 3 units to the RIGHT, and the vertical asymptote moves to x = 3", "math": "Vertical wall is now at x = 3" }
        ],
        "answer": "Domain: x > 3"
      },
      "tips": [
      ...
      "quiz": [
        ...
        },
        {
          ...
          "type": "multiple-choice",
          "options": ["x > 0", "x > 5", "x > âˆ’5", "All numbers"],
          "correct": 1,
      ...
      "practice": [
        {
          "question": "Find the domain of y = log(x + 2)",
          "hint": "Set the expression inside the log (which is x + 2) greater than 0, then solve for x.",
          "answer": "x > âˆ’2",
          "steps": [
            "Rule: inside of log must be > 0",
            "Set up: x + 2 > 0",
            "Solve: subtract 2 from both sides: x > âˆ’2",
            "Domain: x > âˆ’2  (all x values greater than negative 2)"
          ]
        },
        {
          "question": "For y = logâ‚â‚€(x), what is y when x = 1,000?",
          "hint": "Ask: 10 to what power equals 1,000? Count the zeros.",
          "answer": "y = 3",
          "steps": [
            "y = logâ‚â‚€(1000)",
            "Ask: 10^? = 1000",
            "Count the zeros: three zeros in 1000",
            "10Â³ = 1000",
            "So y = 3"
          ]
        }
